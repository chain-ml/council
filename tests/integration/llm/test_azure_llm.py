...
class TestLlmAzure(unittest.TestCase):
    ...
    def test_basic_prompt(self):
        ...
        llm_result = self.llm.post_chat_request(LLMContext.new_fake(), messages)
        ...
        results = self.llm.post_chat_request(LLMContext.new_fake(), messages)
    ...
    def test_censored_prompt(self):
        ...
        with self.assertRaises(LLMException) as e:
            self.llm.post_chat_request(LLMContext.new_fake(), messages)
    ...
    def test_max_token(self):
        ...
        try:
            ...
            messages = [LLMMessage.user_message("Give me an example of a currency")]
            result = llm.post_chat_request(LLMContext.new_fake(), messages)
